...
//     */
//    public static byte[] renderToImage(final JBrowserComponent<?> component) {
//        final JBrowserComponent<?> hiddenWin = new MozillaWindow();
//        hiddenWin.addNotify();
//
//        String b64data =
//                mozSyncExecQuiet(new Callable<String>() {
//
//            public String call() {
