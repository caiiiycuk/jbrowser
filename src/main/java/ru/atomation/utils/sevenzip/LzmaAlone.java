...
public class LzmaAlone
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		if (params.Command == CommandLine.kBenchmak)
		{
			...
			ru.atomation.utils.sevenzip.LzmaBench.LzmaBenchmark(params.NumBenchmarkPasses, dictionary);
		}
		else if (params.Command == CommandLine.kEncode || params.Command == CommandLine.kDecode)
		{
			...
			{
				ru.atomation.utils.sevenzip.compression.lzma.Encoder encoder = new ru.atomation.utils.sevenzip.compression.lzma.Encoder();
			...
			else
			{
				...
				ru.atomation.utils.sevenzip.compression.lzma.Decoder decoder = new ru.atomation.utils.sevenzip.compression.lzma.Decoder();
